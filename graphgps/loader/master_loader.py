...
from graphgps.loader.dataset.citynetwork import CityNetwork
...
def load_dataset_master(format, name, dataset_dir):
    ...
    if format.startswith('PyG-'):
        ...
        elif pyg_dataset_id == 'CityNetwork':
            dataset = preformat_CityNetwork(dataset_dir, name)
...
def preformat_CityNetwork(dataset_dir, name):
    """Load and preformat CityNetwork dataset.
    ...
    Returns:
        PyG dataset object
    """
    dataset = CityNetwork(root=dataset_dir, name=name)
